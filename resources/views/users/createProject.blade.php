...
<div class="container mx-auto max-w-xl bg-white p-6 rounded shadow m-6">
    ...
    <form action="{{ route('user.projectCreate') }}" method="POST" enctype="multipart/form-data" class="flex flex-col justify-start bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <textarea name="description" id="description" rows="4" class="border border-gray-300 rounded px-4 py-2" placeholder="Enter project Description" ></textarea>

        <!-- Type -->
        <label for="type" class="pt-4 pb-2 text-1xl">Type:</label>
        <select name="type" id="type" required class="border border-gray-300 rounded px-4 py-2" placeholder="Enter project type" >
        ...
        <input type="file" name="image_path" id="image_path" accept="image/jpeg" required class="border border-gray-300 rounded px-4 py-2" placeholder="Upload Cover Image" >

        <!-- Additional Images -->
        <label for="additional_images" class="pt-4 pb-2 text-1xl">Additional Images:</label>
        <input type="file" name="additional_images[]" id="additional_images" multiple accept="image/jpeg" class="border border-gray-300 rounded px-4 py-2" placeholder="Add Additional Images" >

        <!-- Status -->
        <label for="status" class="pt-4 pb-2 text-1xl">Status:</label>
        <select name="status" id="status" required class="border border-gray-300 rounded px-4 py-2" placeholder="Enter project status" >
        ...
        <input type="number" name="no_of_floors" id="no_of_floors" required class="border border-gray-300 rounded px-4 py-2" placeholder="Enter number of floors" >

        <!-- Number of Units -->
        <label for="no_of_units" class="pt-4 pb-2 text-1xl">Number of Units:</label>
        <input type="number" name="no_of_units" id="no_of_units" class="border border-gray-300 rounded px-4 py-2" placeholder="Enter number of units" >

        <!-- Size -->
        <label for="size" class="pt-4 pb-2 text-1xl">Size (in sq. ft.):</label>
        <input type="number" name="size" id="size" required class="border border-gray-300 rounded px-4 py-2" placeholder="Enter size per floor" >
